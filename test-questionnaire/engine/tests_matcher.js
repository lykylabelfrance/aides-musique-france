...
// ── T26 : CNM Production Sélective — ancienneté < 1 an = bloqué ──────────────
test('T26 — CNM Production / ancienneté < 1 an / BLOQUÉ', {
  aci: 'non',
  has_struct: 'oui', forme: 'IS', tpe: 'oui',
  activites: ['prod_phono'], ca_phono_pct: 'oui',
  adhesions_struct: 'sppf', distrib: 'physique_cosigne',
  franco: 'oui', nt: 'inf50k', genre: ['ma'],
  anciennete_struct: 'moins_1an',
  nb_albums_produits: '3_ou_plus',
  ca_struct: 'sup100k',
  projets: ['album'],
}, {
  ne_doit_pas: ['CNM_PRODUCTION'],
  doit_matcher: ['CNM_PRODUCTION_AUTO','CIPP','SPPF_ALBUM'],
  conflits: [],
});

// ── T27 : CNM Production Sélective — catalogue < 3 = bloqué ─────────────────
test('T27 — CNM Production / catalogue 1_ou_2 / BLOQUÉ', {
  aci: 'non',
  has_struct: 'oui', forme: 'IS', tpe: 'oui',
  activites: ['prod_phono'], ca_phono_pct: 'oui',
  adhesions_struct: 'sppf', distrib: 'physique_cosigne',
  franco: 'oui', nt: 'inf50k', genre: ['ma'],
  anciennete_struct: '1an_3ans',
  nb_albums_produits: '1_ou_2',
  ca_struct: 'sup100k',
  projets: ['album'],
}, {
  ne_doit_pas: ['CNM_PRODUCTION'],
...
// ── T28 : CNM Production Sélective — CA < 30k = bloqué ──────────────────────
test('T28 — CNM Production / CA < 30k / BLOQUÉ', {
  aci: 'non',
  has_struct: 'oui', forme: 'IS', tpe: 'oui',
  activites: ['prod_phono'], ca_phono_pct: 'oui',
  adhesions_struct: 'sppf', distrib: 'physique_cosigne',
  franco: 'oui', nt: 'inf50k', genre: ['ma'],
  anciennete_struct: '3_ou_plus',
  nb_albums_produits: '3_ou_plus',
  ca_struct: 'inf30k',
  projets: ['album'],
}, {
...
// ── T29 : CNM Production — tous critères OK ──────────────────────────────────
test('T29 — CNM Production / tous critères OK / accessible', {
  aci: 'non',
  has_struct: 'oui', forme: 'IS', tpe: 'oui',
  activites: ['prod_phono'], ca_phono_pct: 'oui',
  adhesions_struct: 'sppf', distrib: 'physique_cosigne',
  ...
  doit_matcher: ['CNM_PRODUCTION','CNM_PRODUCTION_AUTO','CIPP','SPPF_ALBUM'],
  conflits: [],
});

// ── T30 : SACEM Autoproduction — album sorti > 6 mois = bloqué ───────────────
test('T30 — SACEM Autoproduction / album sorti > 6 mois / BLOQUÉ', {
  aci: 'oui',
  affiliations_vous: ['sacem'],
  has_struct: 'non',
  genre: ['ma'],
  projets: ['album'],
  album_timing: 'sorti_plus_6mois',
}, {
  ne_doit_pas: ['SACEM_AUTOPRODUCTION'],
  conflits: [],
});

// ── T31 : SACEM Autoproduction — album pas encore sorti = accessible ──────────
test('T31 — SACEM Autoproduction / album pas encore sorti / accessible', {
  aci: 'oui',
  affiliations_vous: ['sacem'],
  has_struct: 'non',
  genre: ['ma'],
...
// ── T32 : ADAMI 365 — catalogue < 2 albums = bloqué ─────────────────────────
test('T32 — ADAMI 365 / catalogue aucun album / BLOQUÉ', {
  aci: 'oui',
  affiliations_vous: ['sacem','adami'],
  has_struct: 'non',
  nb_albums_produits: 'aucun',
  genre: ['ma'],
  projets: ['album'],
}, {
  ne_doit_pas: ['ADAMI_365'],
  doit_matcher: ['SACEM_AUTOPRODUCTION','ADAMI_2D3D','ADAMI_BOURSE_PARCOURS'],
  conflits: [],
});

// ── T33 : ADAMI 365 — 3+ albums = accessible ────────────────────────────────
test('T33 — ADAMI 365 / 3+ albums / accessible', {
  aci: 'oui',
  affiliations_vous: ['sacem','adami'],
  has_struct: 'non',
  nb_albums_produits: '3_ou_plus',
